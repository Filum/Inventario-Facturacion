...
namespace Entidades
{
    public class EntidadRoles
    {
        ...
        public EntidadRoles(string v_Nombre,string v_Estado, string v_Mant_clientes, string v_Mant_proveedores, string v_Mant_productos, string v_Mant_usuarios, string v_Mant_roles, string v_factu, string v_bitacora)
        {
