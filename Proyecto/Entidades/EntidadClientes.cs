...
namespace Entidades
{
    public class EntidadClientes
    {
        ...
        public EntidadClientes(Int32 v_Codigo, string v_NombreCompleto, string v_Correo, string v_CorreoOpc, int v_Teleoficina, int v_Telemovil, string v_Inactividad, string v_Observaciones)
        {
