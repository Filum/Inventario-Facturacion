...
namespace Entidades
{
    class EntidadUsuarios
    {
        ...
        public EntidadUsuarios(Int64 v_IdUsuario, Int64 v_CedIdentificacion, string v_NombreUsuario, string v_Apellidos, Int64 v_TelefonoHabitacion, Int64 v_TelefonoMovil, string v_Correo, string v_Puesto, Int64 v_IdRol, string v_UsuarioSistema, string v_Contrasena)
        {
